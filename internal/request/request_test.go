...
func TestRequestLineParseGetKoParts(t *testing.T) {
	...
	require.ErrorIs(t, err, InvalidHttpRequestLine)
}
...
func TestRequestLineParseInvalidMethod(t *testing.T) {
	...
	require.ErrorIs(t, err, InvalidHttpMethod)
}
...
func TestRequestLineParseInvalidHttpVersion(t *testing.T) {
	...
	require.ErrorIs(t, err, InvalidHttpVersion)
}
...
func TestParseHeadersKo(t *testing.T) {
	reader := &chunkReader{
		data:            "GET / HTTP/1.1\r\nHost localhost:42069\r\n\r\n",
		numBytesPerRead: 3,
	}
